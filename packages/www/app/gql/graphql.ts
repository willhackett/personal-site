...
export type MetricsQuery = { __typename?: 'Query', metrics: Array<{ __typename: 'FloatMetric', float: number, name: MetricName } | { __typename: 'MediaMetric', artist: string, title: string, name: MetricName } | { __typename: 'TextMetric', name: MetricName, text: string }> };

export type NotesQueryVariables = Exact<{ [key: string]: never; }>;


export type NotesQuery = { __typename?: 'Query', notes: Array<{ __typename?: 'NoteContent', date: string, permalink: string, section: string, summary: string, title: string }> };

export type HomeViewQueryVariables = Exact<{ [key: string]: never; }>;


export type HomeViewQuery = { __typename?: 'Query', textContent: Array<{ __typename?: 'TextContent', name: string, text: string }> };
